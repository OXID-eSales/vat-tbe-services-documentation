...
html_context = {
    ...
    'versions': [
        ...
        ('4.3', 'https://docs.oxid-esales.com/modules/vat-tbe-services/de/4.3/'),
        ('4.4', 'https://docs.oxid-esales.com/modules/vat-tbe-services/de/4.4/'),
     ],
    'languages':
       [('DE', 'https://docs.oxid-esales.com/modules/vat-tbe-services/de/4.3/'),
        ('EN', 'https://docs.oxid-esales.com/modules/vat-tbe-services/en/4.3/')],
...
#
html_title = 'eVAT | Moduldokumentation'
...
latex_documents = [
    (master_doc, 'eVAT.tex', 'eVAT module documentation',
...
man_pages = [
    (master_doc, 'eVAT', 'eVAT module documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'eVAT', 'eVAT module documentation',
     author, 'eVAT', 'One line description of project.',
     'Miscellaneous'),
]
